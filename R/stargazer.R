...
function(..., type = "latex", title="", style="default", summary=NULL, out=NULL, out.header=FALSE,
         ...
         decimal.mark=NULL, df=TRUE, digit.separate=NULL, digit.separator=NULL, digits=NULL, p_digits=NULL, t_digits=NULL, digits.extra=NULL, 
         flip=FALSE,
  ...
  return(.stargazer.wrap(..., type=type, title=title, style=style, summary=summary, out=out, out.header=out.header,
                         ...
                         digits=digits, p_digits=p_digits, t_digits=t_digits, 
